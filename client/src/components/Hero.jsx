  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-2 place-items-center gap-8 items-center mt-20 max-w-[1400px] mx-auto px-6">
      <div className="text-center lg:text-left">
        ...
        <div className="flex mt-6 w-fit justify-center items-center px-3 py-1.5 md:px-4 md:py-2 lg:px-6 lg:py-3 bg-primary rounded-md gap-2 cursor-pointer mx-auto lg:mx-0 hover:bg-primary/90 transition-all">
